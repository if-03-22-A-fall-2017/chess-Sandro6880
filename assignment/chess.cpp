...
#include "chess.h"
 ...
 {
   if (s1_r - s2_r != 0 && (s1_f-'a') - (s2_f-'a') != 0 && s1_r - s2_r < 3 && s1_r - s2_r > -3 &&(s1_f-'a') - (s2_f-'a')< 3 && (s1_f-'a') - (s2_f-'a')> -3)
   {
     return true;
   }
   else return false;
 ...
 bool squares_share_queens_move (File s1_f, Rank s1_r, File s2_f, Rank s2_r)
 {
   ...
   if(squares_share_rank(s1_f, s1_r, s2_f, s2_r) || squares_share_file(s1_f, s1_r, s2_f, s2_r))
   {
     return true;
   }
   return false;
